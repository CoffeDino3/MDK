...
public class MapleBoatEntity extends Boat {
    ...
    public MapleBoatEntity(EntityType<? extends Boat> entityType, Level level) {
        super(entityType, level);
    }

    public MapleBoatEntity(Level level, double x, double y, double z) {
        this(ModEntities.MAPLE_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
    ...
    protected Vec3 getPassengerAttachmentPoint(Entity entity, EntityDimensions dimensions, float partialTick) {
        ...
        return (new Vec3(0.0D, -0.25D, (double)zOffset))
