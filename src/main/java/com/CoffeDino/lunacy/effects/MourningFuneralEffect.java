...
public class MourningFuneralEffect extends MobEffect {
    ...
    public static void spawnContinuousParticles(LivingEntity entity, ServerLevel level, int amplifier) {
    ...
    public static void spawnHitParticles(LivingEntity entity, ServerLevel level, int amplifier) {
    ...
    public static void spawnAdditionalParticles(LivingEntity entity, ServerLevel level, int amplifier) {
